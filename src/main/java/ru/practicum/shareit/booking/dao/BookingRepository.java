...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findByBookerIdAndStatus(Long bookerId, Booking.Status status, Pageable page);

    List<Booking> findByBooker_IdAndEndIsBefore(Long bookerId, LocalDateTime end, Sort sort);

    List<Booking> findByBooker_IdAndEndIsBefore(Long bookerId, LocalDateTime end, Pageable page);

    List<Booking> findByBooker_IdAndStartIsAfter(Long bookerId, LocalDateTime start, Sort sort);

    List<Booking> findByBooker_IdAndStartIsAfter(Long bookerId, LocalDateTime start, Pageable page);
    ...
    List<Booking> findByBooker_IdAndStartIsBeforeAndEndIsAfter(Long bookerId, LocalDateTime dateTime, LocalDateTime dateTime2, Pageable page);

    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1")
    List<Booking> findByOwnerId(Long ownerId, Sort sort);

    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1")
    List<Booking> findByOwnerId(Long ownerId, Pageable page);
    ...
    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1 AND b.status = ?2")
    List<Booking> findByOwnerIdAndStatus(Long ownerId, Booking.Status status, Pageable page);
    ...
    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1 AND b.end < ?2")
    List<Booking> findByOwnerIdAndEndBefore(Long ownerId, LocalDateTime time, Pageable page);
    ...
    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1 AND b.start > ?2")
    List<Booking> findByOwnerIdAndSAndStartIsAfter(Long ownerId, LocalDateTime time, Pageable page);
    ...
    @Query("SELECT b FROM Booking b JOIN b.item i JOIN i.owner o WHERE o.id = ?1 AND (b.start < ?2 AND b.end > ?3)")
    List<Booking> findByOwnerIdAndStartIsBeforeAndEndIsAfter(Long ownerId, LocalDateTime time, LocalDateTime time2, Pageable page);
}
